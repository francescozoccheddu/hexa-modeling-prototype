...
namespace HMP::Meshing::Projection
{
    ...
    std::vector<Vec> project(const cinolib::Hexmesh<>& _source, const cinolib::Polygonmesh<>& _target, const std::vector<Point>& _pointFeats, const std::vector<Path>& _edgeFeats, const Options& _options = {})
    {
